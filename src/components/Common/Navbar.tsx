...
export function Navbar({ user, userProfile, onLogout, children }: NavbarProps) {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3">
      ...
      {/* Dropdown Menu */}
      {isMenuOpen && user && (
        <div className="absolute right-4 top-16 w-48 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 py-2 z-50">
          ...
          <button
            className="w-full px-4 py-2 text-left text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 flex items-center gap-2 transition-colors"
          >
          ...
          <button
            ...
            className="w-full px-4 py-2 text-left text-red-600 hover:bg-red-50 dark:hover:bg-red-950 flex items-center gap-2 transition-colors"
          >
